...
CREATE TABLE `zakazy` (
  `ID zakaza` int NOT NULL AUTO_INCREMENT,
  `Zakazchik` varchar(255) DEFAULT NULL,
  `IDSotrudnika` int DEFAULT NULL,
  `DataZakaza` datetime DEFAULT NULL,
  `ID Tovara` int DEFAULT NULL,
  PRIMARY KEY (`ID zakaza`),
  KEY `ID Tovara` (`ID Tovara`),
  KEY `Zakazchik` (`Zakazchik`)
